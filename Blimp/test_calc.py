import unittest
import propulsion_power
import structures
import first_concept
import projected_panel

class TestTest(unittest.TestCase):

    #def test_read_irradiance(self): #idk how to test this
    ...
    def test_required_density_gas(self):
        self.assertEqual(structures.required_density_gas())
    ...
    def test_drag(self): #error (int object is not subscriptable)
    ...
    def test_velocity(self): #error formula, "max_eff" not defined
    ...
    #def test_computeArea(self): #not able to preform test

    def test_angle(self): #function only gives 0.0 , needs to be checked

    def test_irradiance_distribution(self): #cant calculate
        self.assertEqual(
