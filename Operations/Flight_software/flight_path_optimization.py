...
def optimal_path(sensor_df,dlat,dlon,range_weight,cruise_alt):
    print("optimizing sensor path: range weight=", range_weight)
    ...
    route_finder = RouteFinder(list(matrix),list(np.arange(len(points))), iterations=5)
